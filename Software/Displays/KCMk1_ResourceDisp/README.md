...
**Touch.** A tap anywhere on a meter opens the Detail screen on that resource. A touch held still on its tape for a second and a half sets a reserve bug there, or clears the bug it landed on; a touch on a bug that moves drags it. The release after a matured hold or a drag does nothing.
