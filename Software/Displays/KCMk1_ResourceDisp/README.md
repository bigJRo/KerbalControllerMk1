...
| `TTE_WINDOW_MS` | `AAA_Config.ino` | `10000` | Rate sample window behind the TTE counter. Longer than the trend window so slow drains register; with the deadband above, the slowest reportable drain is about 5.5 hours to empty. |
