...
static const int16_t  NAV_SHIP_W      = 110;
static const int16_t  NAV_SHIP_H      = 122;
static const int16_t  NAV_SHIP_STRIDE = 14;
static const uint8_t  NAV_SHIP_BMP[] = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   // row 0 = nose
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1F, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xFF, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xFF, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xFF, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  ,
  ...
  ,
  ...
  ,
};
...
// ── Marker legend ─────────────────────────────────────────────────────────────────────
// Under the left column, in the space the card does not reach. The two coloured
// triangles on the rose are the only things on this screen with no name attached, and
// colour alone is not a label.
static const int16_t NAV_KEY_X  = 12;
static const int16_t NAV_KEY_Y  = 404;
static const int16_t NAV_KEY_DY = 40;
static const int16_t NAV_KEY_TRI_W = 16;
static const int16_t NAV_KEY_TRI_H = 14;
...
static void _navKeyRow(KCM_TFT &tft, int16_t y, uint16_t colour, const char *name) {
  ...
  const int16_t cyRow = y + 16;
  tft.fillTriangle(NAV_KEY_X + w / 2, cyRow - h / 2,
                   NAV_KEY_X,         cyRow + h / 2,
                   NAV_KEY_X + w,     cyRow + h / 2, colour);
  textLeft(tft, &Roboto_Black_24, NAV_KEY_X + w + 2, y, 120, 32, name, colour, TFT_BLACK);
}
