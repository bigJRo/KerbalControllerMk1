...
static const uint8_t TGT_DOT_R_TGT   = 6;   // target marker radius
static const uint8_t TGT_DOT_R_VEL   = 5;   // velocity marker radius
static const uint8_t TGT_DOT_R_ERASE = 11;  // erase rect half-size (covers prograde ring 5 + spoke 4)
