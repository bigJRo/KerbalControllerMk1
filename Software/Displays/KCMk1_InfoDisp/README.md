...
- **KerbalDisplayCommon ≥ 3.2.0** is required (hardware rev 2 / `KCM_TFT`, `RA8876_t41_p`; 3.2.0 carries the shared reticle marker layer and `kspCockpitOffset`). Do not downgrade.
