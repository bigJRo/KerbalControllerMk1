...
- **KerbalDisplayCommon ≥ 3.3.0** is required (hardware rev 2 / `KCM_TFT`, `RA8876_t41_p`; 3.3.0 carries the shared reticle marker layer and the `kspBodyAxes` / `kspBoresightAngles` boresight projection). Do not downgrade.
