...
static const uint16_t BS_ROW_H = 27;   // 24px (KcmTerm_24, cell 24) + 3px leading
static const uint16_t BS_COL_X = 4;
static const tFont   *BS_FONT  = &KcmTerm_24;   // body — enlarged from 16px for readability
static const tFont   *BS_BIG   = &KcmTerm_40;   // titles / big lines (clean 2x-native-20 heading)
...
****************************************************************************************/
static void _boot_B(KCM_TFT &tft) {
...
****************************************************************************************/
static void _boot_C(KCM_TFT &tft) {
