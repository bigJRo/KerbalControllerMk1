# KCMk1_Joystick_Rotation

**Module:** Joystick Rotation  
**Version:** 1.0  
**Date:** 2026-04-08  
...
![Joystick Rotation Panel Layout](panel_layout.svg)
...
|---|---|---|---|---|
| BTN01 | PC0 | Reset Trim | GREEN | Resets all trim to zero |
| BTN02 | PB3 | Trim Set | AMBER | Sets current position as trim reference |
...
1. Open `KCMk1_Joystick_Rotation.ino` in Arduino IDE
...
| `0x26` | EVA Module |
| `0x27` | Reserved |
| `0x28` | **Joystick Rotation** — this module |
