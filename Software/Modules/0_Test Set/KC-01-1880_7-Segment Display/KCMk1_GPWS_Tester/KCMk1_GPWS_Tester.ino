/**
 * @file        KCMk1_GPWS_Controller.ino
 * @version     2.0.0
 * @date        2026-04-28
 ...
 * @target      Xiao RA4M1
 *
 * @brief       GPWS Input Panel module controller / tester.
 *
 *              Acts as I2C master for the KC-01-1880 module running
 *              KCMk1_GPWS_Input.ino. Handles the full lifecycle and
 *              prints GPWS state to serial on every INT.
 *
